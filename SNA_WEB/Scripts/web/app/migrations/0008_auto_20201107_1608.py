# Generated by Django 3.0.8 on 2020-11-07 07:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        django_db_views.operations.ViewRunPython(
            ...
            reverse_code=django_db_views.migration_functions.BackwardViewMigration("select equipment.eq_ip, vnd.name as vnd_name, vnd.codetype as vnd_codetype, \n mdl.name as mdl_name, mdl.codetype as mdl_name, equipment.descr, equipment.location,\nequipment.name, equipment.vendor, equipment.manage, equipment.team\n        from equipment \n        left outer join code vnd on equipment.vendor = vnd.code_value\n        and vnd.codetype = 'com_vender' \n        left outer join code mdl on equipment.model = mdl.code_value\n        and mdl.codetype = 'com_model'", 'equip_code'),
            atomic=False,
        ),
    ]
